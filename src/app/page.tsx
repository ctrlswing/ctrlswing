...
const caseStudies = [
  {
    ...
    outerBg: "bg-sage/20",
    innerBg: "bg-white",
    innerBorder: "border-charcoal/5",
    chromeBg: "bg-charcoal/5",
    chromeBorder: "border-charcoal/10",
  },
  {
    name: "Valle Ballet",
    location: "San Diego",
    ...
    outerBg: "bg-charcoal/5",
    innerBg: "bg-charcoal",
    innerBorder: "border-charcoal",
    chromeBg: "bg-darkgray",
    chromeBorder: "border-sage/10",
  },
  {
    name: "BornSimple",
