            ...
            <div className="flex flex-col w-full animate-[fadeIn_0.3s_ease-in-out]">
              ...
              <div className="mb-10">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-transparent border border-sage/20 rounded-xl p-6 text-white font-satoshi text-lg placeholder:text-sage/50 focus:border-yellow focus:outline-none focus:ring-0 transition-colors resize-none"
                />
              </div>
