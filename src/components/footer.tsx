      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-10">
          <div>
            ...
            <p className="font-satoshi text-sage/60 text-sm mt-2">
              Jackson Dean / San Diego, CA
            </p>
          </div>

          <div className="flex flex-wrap gap-x-8 gap-y-3 font-satoshi text-sm">
            <Link
              href="/workshop"
              className="text-sage/80 hover:text-yellow transition-colors duration-200"
            >
              Workshop
            </Link>
            <Link
        ...
        <div className="border-t border-sage/10 pt-6">
          <p className="font-satoshi text-sage/40 text-xs">
            &copy; {new Date().getFullYear()} ctrlswing. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
